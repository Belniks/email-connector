    ...
    fromGraph: (message) => {
        return {
            ...
            bccRecipients: message.bccRecipients
                ? recipient_mapper_1.RecipientMapper.fromGraphArray(message.bccRecipients)
                : [],
            ccRecipients: message.ccRecipients
                ? recipient_mapper_1.RecipientMapper.fromGraphArray(message.ccRecipients)
                : [],
            ...
            internetMessageHeaders: message.internetMessageHeaders
                ? internet_message_headers_mapper_1.InternetMessageHeadersMapper.fromGraphArray(message.internetMessageHeaders)
                : [],
            lastModifiedDateTime: new Date(message.lastModifiedDateTime),
            parentFolderId: message.parentFolderId,
            receivedDateTime: new Date(message.receivedDateTime),
            replyTo: message.replyTo
                ? recipient_mapper_1.RecipientMapper.fromGraphArray(message.replyTo)
                : [],
